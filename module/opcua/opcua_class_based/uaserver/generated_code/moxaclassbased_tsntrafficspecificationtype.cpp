/******************************************************************************
** moxaclassbased_tsntrafficspecificationtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class TsnTrafficSpecificationType.
 ...
 */
TsnTrafficSpecificationType::TsnTrafficSpecificationType(
...
: TsnTrafficSpecificationTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
TsnTrafficSpecificationType::TsnTrafficSpecificationType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: TsnTrafficSpecificationTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class TsnTrafficSpecificationType with all components.
*/
TsnTrafficSpecificationType::TsnTrafficSpecificationType(
...
: TsnTrafficSpecificationTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void TsnTrafficSpecificationType::createTypes()
{
    // Call base class
    TsnTrafficSpecificationTypeBase::createTypes();
...
*/
void TsnTrafficSpecificationType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    TsnTrafficSpecificationTypeBase::clearStaticMembers();
}
