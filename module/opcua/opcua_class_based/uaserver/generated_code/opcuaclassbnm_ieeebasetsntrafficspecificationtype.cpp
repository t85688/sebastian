/******************************************************************************
** opcuaclassbnm_ieeebasetsntrafficspecificationtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeBaseTsnTrafficSpecificationType.
 ...
 */
IeeeBaseTsnTrafficSpecificationType::IeeeBaseTsnTrafficSpecificationType(
...
: IeeeBaseTsnTrafficSpecificationTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeBaseTsnTrafficSpecificationType::IeeeBaseTsnTrafficSpecificationType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeBaseTsnTrafficSpecificationTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeBaseTsnTrafficSpecificationType with all components.
*/
IeeeBaseTsnTrafficSpecificationType::IeeeBaseTsnTrafficSpecificationType(
...
: IeeeBaseTsnTrafficSpecificationTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeBaseTsnTrafficSpecificationType::createTypes()
{
    // Call base class
    IeeeBaseTsnTrafficSpecificationTypeBase::createTypes();
...
*/
void IeeeBaseTsnTrafficSpecificationType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeBaseTsnTrafficSpecificationTypeBase::clearStaticMembers();
}
