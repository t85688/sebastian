/******************************************************************************
** opcuaclassbnm_iprioritymappingentrytype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IPriorityMappingEntryType.
...
: IPriorityMappingEntryTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IPriorityMappingEntryType::IPriorityMappingEntryType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IPriorityMappingEntryTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IPriorityMappingEntryType with all components.
*/
IPriorityMappingEntryType::IPriorityMappingEntryType(
...
: IPriorityMappingEntryTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IPriorityMappingEntryType::createTypes()
{
    // Call base class
    IPriorityMappingEntryTypeBase::createTypes();
...
*/
void IPriorityMappingEntryType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IPriorityMappingEntryTypeBase::clearStaticMembers();
}
