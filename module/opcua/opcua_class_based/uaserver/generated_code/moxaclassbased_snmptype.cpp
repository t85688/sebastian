...
/** Construction of the class SNMPType.
...
: SNMPTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
SNMPType::SNMPType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: SNMPTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class SNMPType with all components.
*/
SNMPType::SNMPType(
...
: SNMPTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void SNMPType::createTypes()
{
    // Call base class
    SNMPTypeBase::createTypes();
...
*/
void SNMPType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    SNMPTypeBase::clearStaticMembers();
}
