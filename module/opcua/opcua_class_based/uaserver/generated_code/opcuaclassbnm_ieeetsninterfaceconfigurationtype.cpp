/******************************************************************************
** opcuaclassbnm_ieeetsninterfaceconfigurationtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeTsnInterfaceConfigurationType.
 ...
 */
IeeeTsnInterfaceConfigurationType::IeeeTsnInterfaceConfigurationType(
...
: IeeeTsnInterfaceConfigurationTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeTsnInterfaceConfigurationType::IeeeTsnInterfaceConfigurationType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeTsnInterfaceConfigurationTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeTsnInterfaceConfigurationType with all components.
*/
IeeeTsnInterfaceConfigurationType::IeeeTsnInterfaceConfigurationType(
...
: IeeeTsnInterfaceConfigurationTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeTsnInterfaceConfigurationType::createTypes()
{
    // Call base class
    IeeeTsnInterfaceConfigurationTypeBase::createTypes();
...
*/
void IeeeTsnInterfaceConfigurationType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeTsnInterfaceConfigurationTypeBase::clearStaticMembers();
}
