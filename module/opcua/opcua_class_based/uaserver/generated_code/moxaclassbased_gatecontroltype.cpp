/******************************************************************************
** moxaclassbased_gatecontroltype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class GateControlType.
 ...
 */
GateControlType::GateControlType(
...
: GateControlTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
GateControlType::GateControlType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: GateControlTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class GateControlType with all components.
*/
GateControlType::GateControlType(
...
: GateControlTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void GateControlType::createTypes()
{
    // Call base class
    GateControlTypeBase::createTypes();
...
*/
void GateControlType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    GateControlTypeBase::clearStaticMembers();
}
