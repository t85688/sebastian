/******************************************************************************
** opcuaclassbnm_ibaseethernetcapabilitiestype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IBaseEthernetCapabilitiesType.
...
: IBaseEthernetCapabilitiesTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IBaseEthernetCapabilitiesType::IBaseEthernetCapabilitiesType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IBaseEthernetCapabilitiesTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IBaseEthernetCapabilitiesType with all components.
*/
IBaseEthernetCapabilitiesType::IBaseEthernetCapabilitiesType(
...
: IBaseEthernetCapabilitiesTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IBaseEthernetCapabilitiesType::createTypes()
{
    // Call base class
    IBaseEthernetCapabilitiesTypeBase::createTypes();
...
*/
void IBaseEthernetCapabilitiesType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IBaseEthernetCapabilitiesTypeBase::clearStaticMembers();
}
