/******************************************************************************
** opcuaclassbnm_iieeetsnvlantagtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeTsnVlanTagType.
...
: IIeeeTsnVlanTagTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeTsnVlanTagType::IIeeeTsnVlanTagType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeTsnVlanTagTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeTsnVlanTagType with all components.
*/
IIeeeTsnVlanTagType::IIeeeTsnVlanTagType(
...
: IIeeeTsnVlanTagTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeTsnVlanTagType::createTypes()
{
    // Call base class
    IIeeeTsnVlanTagTypeBase::createTypes();
...
*/
void IIeeeTsnVlanTagType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeTsnVlanTagTypeBase::clearStaticMembers();
}
