...
BroadcastSearchAndIPSettingStateMachineType::BroadcastSearchAndIPSettingStateMachineType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: BroadcastSearchAndIPSettingStateMachineTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}
 ...
 *  @param[in] serviceContext General context for the service calls containing information like the session object, return diagnostic mask and timeout hint.
 */
UaStatus BroadcastSearchAndIPSettingStateMachineType::StartInit(
    const ServiceContext& serviceContext)
{
    OpcUa_ReferenceParameter(serviceContext);
    UaStatus ret;
 ...
 *  @param[in] serviceContext General context for the service calls containing information like the session object, return diagnostic mask and timeout hint.
 */
UaStatus BroadcastSearchAndIPSettingStateMachineType::StartLinkSequenceDetect(
    const ServiceContext& serviceContext)
{
    OpcUa_ReferenceParameter(serviceContext);
    UaStatus ret;
