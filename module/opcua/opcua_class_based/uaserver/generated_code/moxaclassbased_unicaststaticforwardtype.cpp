/******************************************************************************
** moxaclassbased_unicaststaticforwardtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class UnicastStaticForwardType.
 ...
 */
UnicastStaticForwardType::UnicastStaticForwardType(
...
: UnicastStaticForwardTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
UnicastStaticForwardType::UnicastStaticForwardType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: UnicastStaticForwardTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class UnicastStaticForwardType with all components.
*/
UnicastStaticForwardType::UnicastStaticForwardType(
...
: UnicastStaticForwardTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void UnicastStaticForwardType::createTypes()
{
    // Call base class
    UnicastStaticForwardTypeBase::createTypes();
...
*/
void UnicastStaticForwardType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    UnicastStaticForwardTypeBase::clearStaticMembers();
}
