/******************************************************************************
** moxaclassbased_ieeedot1as2011type.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeDot1AS2011Type.
 ...
 */
IeeeDot1AS2011Type::IeeeDot1AS2011Type(
...
: IeeeDot1AS2011TypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeDot1AS2011Type::IeeeDot1AS2011Type(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeDot1AS2011TypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeDot1AS2011Type with all components.
*/
IeeeDot1AS2011Type::IeeeDot1AS2011Type(
...
: IeeeDot1AS2011TypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeDot1AS2011Type::createTypes()
{
    // Call base class
    IeeeDot1AS2011TypeBase::createTypes();
...
*/
void IeeeDot1AS2011Type::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeDot1AS2011TypeBase::clearStaticMembers();
}
