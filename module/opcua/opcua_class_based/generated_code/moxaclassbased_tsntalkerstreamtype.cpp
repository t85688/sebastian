/******************************************************************************
** moxaclassbased_tsntalkerstreamtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class TsnTalkerStreamType.
 ...
 */
TsnTalkerStreamType::TsnTalkerStreamType(
...
: TsnTalkerStreamTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
TsnTalkerStreamType::TsnTalkerStreamType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: TsnTalkerStreamTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class TsnTalkerStreamType with all components.
*/
TsnTalkerStreamType::TsnTalkerStreamType(
...
: TsnTalkerStreamTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void TsnTalkerStreamType::createTypes()
{
    // Call base class
    TsnTalkerStreamTypeBase::createTypes();
...
*/
void TsnTalkerStreamType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    TsnTalkerStreamTypeBase::clearStaticMembers();
}
