/******************************************************************************
** opcuaclassbnm_iieeebasetsntrafficspecificationtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeBaseTsnTrafficSpecificationType.
...
: IIeeeBaseTsnTrafficSpecificationTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeBaseTsnTrafficSpecificationType::IIeeeBaseTsnTrafficSpecificationType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeBaseTsnTrafficSpecificationTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeBaseTsnTrafficSpecificationType with all components.
*/
IIeeeBaseTsnTrafficSpecificationType::IIeeeBaseTsnTrafficSpecificationType(
...
: IIeeeBaseTsnTrafficSpecificationTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeBaseTsnTrafficSpecificationType::createTypes()
{
    // Call base class
    IIeeeBaseTsnTrafficSpecificationTypeBase::createTypes();
...
*/
void IIeeeBaseTsnTrafficSpecificationType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeBaseTsnTrafficSpecificationTypeBase::clearStaticMembers();
}
