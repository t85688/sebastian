/******************************************************************************
** moxaclassbased_deviceinformationtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class DeviceInformationType.
 ...
 */
DeviceInformationType::DeviceInformationType(
...
: DeviceInformationTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
DeviceInformationType::DeviceInformationType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: DeviceInformationTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class DeviceInformationType with all components.
*/
DeviceInformationType::DeviceInformationType(
...
: DeviceInformationTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void DeviceInformationType::createTypes()
{
    // Call base class
    DeviceInformationTypeBase::createTypes();
...
*/
void DeviceInformationType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    DeviceInformationTypeBase::clearStaticMembers();
}
