/******************************************************************************
** opcuaclassbnm_ieeetsnmacaddresstype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeTsnMacAddressType.
 ...
 */
IeeeTsnMacAddressType::IeeeTsnMacAddressType(
...
: IeeeTsnMacAddressTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeTsnMacAddressType::IeeeTsnMacAddressType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeTsnMacAddressTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeTsnMacAddressType with all components.
*/
IeeeTsnMacAddressType::IeeeTsnMacAddressType(
...
: IeeeTsnMacAddressTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeTsnMacAddressType::createTypes()
{
    // Call base class
    IeeeTsnMacAddressTypeBase::createTypes();
...
*/
void IeeeTsnMacAddressType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeTsnMacAddressTypeBase::clearStaticMembers();
}
