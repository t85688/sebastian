/******************************************************************************
** opcuaclassbnm_iieeetsninterfaceconfigurationtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeTsnInterfaceConfigurationType.
...
: IIeeeTsnInterfaceConfigurationTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeTsnInterfaceConfigurationType::IIeeeTsnInterfaceConfigurationType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeTsnInterfaceConfigurationTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeTsnInterfaceConfigurationType with all components.
*/
IIeeeTsnInterfaceConfigurationType::IIeeeTsnInterfaceConfigurationType(
...
: IIeeeTsnInterfaceConfigurationTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeTsnInterfaceConfigurationType::createTypes()
{
    // Call base class
    IIeeeTsnInterfaceConfigurationTypeBase::createTypes();
...
*/
void IIeeeTsnInterfaceConfigurationType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeTsnInterfaceConfigurationTypeBase::clearStaticMembers();
}
