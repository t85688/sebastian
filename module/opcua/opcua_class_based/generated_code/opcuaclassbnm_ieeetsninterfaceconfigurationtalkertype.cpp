/******************************************************************************
** opcuaclassbnm_ieeetsninterfaceconfigurationtalkertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeTsnInterfaceConfigurationTalkerType.
 ...
 */
IeeeTsnInterfaceConfigurationTalkerType::IeeeTsnInterfaceConfigurationTalkerType(
...
: IeeeTsnInterfaceConfigurationTalkerTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeTsnInterfaceConfigurationTalkerType::IeeeTsnInterfaceConfigurationTalkerType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeTsnInterfaceConfigurationTalkerTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeTsnInterfaceConfigurationTalkerType with all components.
*/
IeeeTsnInterfaceConfigurationTalkerType::IeeeTsnInterfaceConfigurationTalkerType(
...
: IeeeTsnInterfaceConfigurationTalkerTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeTsnInterfaceConfigurationTalkerType::createTypes()
{
    // Call base class
    IeeeTsnInterfaceConfigurationTalkerTypeBase::createTypes();
...
*/
void IeeeTsnInterfaceConfigurationTalkerType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeTsnInterfaceConfigurationTalkerTypeBase::clearStaticMembers();
}
