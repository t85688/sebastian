/******************************************************************************
** opcuaclassbnm_iieeebasetsnstreamtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeBaseTsnStreamType.
...
: IIeeeBaseTsnStreamTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeBaseTsnStreamType::IIeeeBaseTsnStreamType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeBaseTsnStreamTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeBaseTsnStreamType with all components.
*/
IIeeeBaseTsnStreamType::IIeeeBaseTsnStreamType(
...
: IIeeeBaseTsnStreamTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeBaseTsnStreamType::createTypes()
{
    // Call base class
    IIeeeBaseTsnStreamTypeBase::createTypes();
...
*/
void IIeeeBaseTsnStreamType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeBaseTsnStreamTypeBase::clearStaticMembers();
}
