/******************************************************************************
** opcuaclassbnm_ietfbasenetworkinterfacetype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IetfBaseNetworkInterfaceType.
...
: IetfBaseNetworkInterfaceTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IetfBaseNetworkInterfaceType::IetfBaseNetworkInterfaceType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IetfBaseNetworkInterfaceTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IetfBaseNetworkInterfaceType with all components.
*/
IetfBaseNetworkInterfaceType::IetfBaseNetworkInterfaceType(
...
: IetfBaseNetworkInterfaceTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IetfBaseNetworkInterfaceType::createTypes()
{
    // Call base class
    IetfBaseNetworkInterfaceTypeBase::createTypes();
...
*/
void IetfBaseNetworkInterfaceType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IetfBaseNetworkInterfaceTypeBase::clearStaticMembers();
}
