/******************************************************************************
** moxaclassbased_discoveredbridgetype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class DiscoveredBridgeType.
 ...
 */
DiscoveredBridgeType::DiscoveredBridgeType(
...
: DiscoveredBridgeTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
DiscoveredBridgeType::DiscoveredBridgeType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: DiscoveredBridgeTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class DiscoveredBridgeType with all components.
*/
DiscoveredBridgeType::DiscoveredBridgeType(
...
: DiscoveredBridgeTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void DiscoveredBridgeType::createTypes()
{
    // Call base class
    DiscoveredBridgeTypeBase::createTypes();
...
*/
void DiscoveredBridgeType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    DiscoveredBridgeTypeBase::clearStaticMembers();
}
