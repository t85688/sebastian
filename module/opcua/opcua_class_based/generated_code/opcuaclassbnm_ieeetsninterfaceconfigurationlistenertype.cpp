/******************************************************************************
** opcuaclassbnm_ieeetsninterfaceconfigurationlistenertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeTsnInterfaceConfigurationListenerType.
 ...
 */
IeeeTsnInterfaceConfigurationListenerType::IeeeTsnInterfaceConfigurationListenerType(
...
: IeeeTsnInterfaceConfigurationListenerTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeTsnInterfaceConfigurationListenerType::IeeeTsnInterfaceConfigurationListenerType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeTsnInterfaceConfigurationListenerTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeTsnInterfaceConfigurationListenerType with all components.
*/
IeeeTsnInterfaceConfigurationListenerType::IeeeTsnInterfaceConfigurationListenerType(
...
: IeeeTsnInterfaceConfigurationListenerTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeTsnInterfaceConfigurationListenerType::createTypes()
{
    // Call base class
    IeeeTsnInterfaceConfigurationListenerTypeBase::createTypes();
...
*/
void IeeeTsnInterfaceConfigurationListenerType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeTsnInterfaceConfigurationListenerTypeBase::clearStaticMembers();
}
