/******************************************************************************
** moxaclassbased_ethernetinterfacetype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class EthernetInterfaceType.
...
: EthernetInterfaceTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
EthernetInterfaceType::EthernetInterfaceType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: EthernetInterfaceTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class EthernetInterfaceType with all components.
*/
EthernetInterfaceType::EthernetInterfaceType(
...
: EthernetInterfaceTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void EthernetInterfaceType::createTypes()
{
    // Call base class
    EthernetInterfaceTypeBase::createTypes();
...
*/
void EthernetInterfaceType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    EthernetInterfaceTypeBase::clearStaticMembers();
}
