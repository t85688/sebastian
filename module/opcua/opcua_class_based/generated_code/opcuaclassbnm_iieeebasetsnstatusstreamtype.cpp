/******************************************************************************
** opcuaclassbnm_iieeebasetsnstatusstreamtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeBaseTsnStatusStreamType.
...
: IIeeeBaseTsnStatusStreamTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeBaseTsnStatusStreamType::IIeeeBaseTsnStatusStreamType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeBaseTsnStatusStreamTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeBaseTsnStatusStreamType with all components.
*/
IIeeeBaseTsnStatusStreamType::IIeeeBaseTsnStatusStreamType(
...
: IIeeeBaseTsnStatusStreamTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeBaseTsnStatusStreamType::createTypes()
{
    // Call base class
    IIeeeBaseTsnStatusStreamTypeBase::createTypes();
...
*/
void IIeeeBaseTsnStatusStreamType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeBaseTsnStatusStreamTypeBase::clearStaticMembers();
}
