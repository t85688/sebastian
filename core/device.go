...
func UpdateDevice(project_id int64, device_id int64, device_conf domain.DeviceConf, is_operation bool) (device_info domain.DeviceInfo, res statuscode.Response) {
