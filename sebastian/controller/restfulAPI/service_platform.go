...
func RequestServicePlatformDeviceCode(c *api.Context) {
	res := core.RequestServicePlatformDeviceCode()
	httputils.Respond(c, res)
}

func GetServicePlatformEndpoint(c *api.Context) {
	res := core.GetServicePlatformEndpoint()
	httputils.Respond(c, res)
}
