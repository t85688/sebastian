...
/** Construction of the class VlanType.
...
: VlanTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
VlanType::VlanType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: VlanTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class VlanType with all components.
*/
VlanType::VlanType(
...
: VlanTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void VlanType::createTypes()
{
    // Call base class
    VlanTypeBase::createTypes();
...
*/
void VlanType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    VlanTypeBase::clearStaticMembers();
}
