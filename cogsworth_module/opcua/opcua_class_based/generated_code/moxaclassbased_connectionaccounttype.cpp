/******************************************************************************
** moxaclassbased_connectionaccounttype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class ConnectionAccountType.
...
: ConnectionAccountTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
ConnectionAccountType::ConnectionAccountType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: ConnectionAccountTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class ConnectionAccountType with all components.
*/
ConnectionAccountType::ConnectionAccountType(
...
: ConnectionAccountTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void ConnectionAccountType::createTypes()
{
    // Call base class
    ConnectionAccountTypeBase::createTypes();
...
*/
void ConnectionAccountType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    ConnectionAccountTypeBase::clearStaticMembers();
}
