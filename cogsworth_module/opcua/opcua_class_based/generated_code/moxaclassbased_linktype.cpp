...
/** Construction of the class LinkType.
...
: LinkTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
LinkType::LinkType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: LinkTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class LinkType with all components.
*/
LinkType::LinkType(
...
: LinkTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void LinkType::createTypes()
{
    // Call base class
    LinkTypeBase::createTypes();
...
*/
void LinkType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    LinkTypeBase::clearStaticMembers();
}
