/******************************************************************************
** opcuaclassbnm_iieeetsninterfaceconfigurationlistenertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeTsnInterfaceConfigurationListenerType.
...
: IIeeeTsnInterfaceConfigurationListenerTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeTsnInterfaceConfigurationListenerType::IIeeeTsnInterfaceConfigurationListenerType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeTsnInterfaceConfigurationListenerTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeTsnInterfaceConfigurationListenerType with all components.
*/
IIeeeTsnInterfaceConfigurationListenerType::IIeeeTsnInterfaceConfigurationListenerType(
...
: IIeeeTsnInterfaceConfigurationListenerTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeTsnInterfaceConfigurationListenerType::createTypes()
{
    // Call base class
    IIeeeTsnInterfaceConfigurationListenerTypeBase::createTypes();
...
*/
void IIeeeTsnInterfaceConfigurationListenerType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeTsnInterfaceConfigurationListenerTypeBase::clearStaticMembers();
}
