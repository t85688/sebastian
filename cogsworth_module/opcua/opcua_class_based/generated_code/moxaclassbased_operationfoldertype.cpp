/******************************************************************************
** moxaclassbased_operationfoldertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class OperationFolderType.
 ...
 */
OperationFolderType::OperationFolderType(
...
: OperationFolderTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
OperationFolderType::OperationFolderType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: OperationFolderTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class OperationFolderType with all components.
*/
OperationFolderType::OperationFolderType(
...
: OperationFolderTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void OperationFolderType::createTypes()
{
    // Call base class
    OperationFolderTypeBase::createTypes();
...
*/
void OperationFolderType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    OperationFolderTypeBase::clearStaticMembers();
}
