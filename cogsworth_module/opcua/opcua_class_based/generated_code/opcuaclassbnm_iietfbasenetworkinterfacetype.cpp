/******************************************************************************
** opcuaclassbnm_iietfbasenetworkinterfacetype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIetfBaseNetworkInterfaceType.
...
: IIetfBaseNetworkInterfaceTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIetfBaseNetworkInterfaceType::IIetfBaseNetworkInterfaceType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIetfBaseNetworkInterfaceTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIetfBaseNetworkInterfaceType with all components.
*/
IIetfBaseNetworkInterfaceType::IIetfBaseNetworkInterfaceType(
...
: IIetfBaseNetworkInterfaceTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIetfBaseNetworkInterfaceType::createTypes()
{
    // Call base class
    IIetfBaseNetworkInterfaceTypeBase::createTypes();
...
*/
void IIetfBaseNetworkInterfaceType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIetfBaseNetworkInterfaceTypeBase::clearStaticMembers();
}
