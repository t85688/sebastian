/******************************************************************************
** opcuaclassbnm_bnmrequesttype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class BnmRequestType.
...
: BnmRequestTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
BnmRequestType::BnmRequestType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: BnmRequestTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class BnmRequestType with all components.
*/
BnmRequestType::BnmRequestType(
...
: BnmRequestTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void BnmRequestType::createTypes()
{
    // Call base class
    BnmRequestTypeBase::createTypes();
...
*/
void BnmRequestType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    BnmRequestTypeBase::clearStaticMembers();
}
 ...
 *  @param[in] StreamConfiguration
 */
UaStatus BnmRequestType::UpdateStreamConfiguration(
 ...
 *
 *  @param[in] serviceContext General context for the service calls containing information like the session object, return diagnostic mask and timeout hint.
 *  @param[in] StreamStatus
 */
UaStatus BnmRequestType::UpdateStreamStatus(
    const ServiceContext& serviceContext,
