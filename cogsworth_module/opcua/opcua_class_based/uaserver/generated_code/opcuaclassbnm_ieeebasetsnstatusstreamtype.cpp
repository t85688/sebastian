/******************************************************************************
** opcuaclassbnm_ieeebasetsnstatusstreamtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeBaseTsnStatusStreamType.
 ...
 */
IeeeBaseTsnStatusStreamType::IeeeBaseTsnStatusStreamType(
...
: IeeeBaseTsnStatusStreamTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeBaseTsnStatusStreamType::IeeeBaseTsnStatusStreamType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeBaseTsnStatusStreamTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeBaseTsnStatusStreamType with all components.
*/
IeeeBaseTsnStatusStreamType::IeeeBaseTsnStatusStreamType(
...
: IeeeBaseTsnStatusStreamTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeBaseTsnStatusStreamType::createTypes()
{
    // Call base class
    IeeeBaseTsnStatusStreamTypeBase::createTypes();
...
*/
void IeeeBaseTsnStatusStreamType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeBaseTsnStatusStreamTypeBase::clearStaticMembers();
}
