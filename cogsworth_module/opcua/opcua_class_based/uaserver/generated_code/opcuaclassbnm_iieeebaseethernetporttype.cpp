/******************************************************************************
** opcuaclassbnm_iieeebaseethernetporttype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeBaseEthernetPortType.
...
: IIeeeBaseEthernetPortTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeBaseEthernetPortType::IIeeeBaseEthernetPortType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeBaseEthernetPortTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeBaseEthernetPortType with all components.
*/
IIeeeBaseEthernetPortType::IIeeeBaseEthernetPortType(
...
: IIeeeBaseEthernetPortTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeBaseEthernetPortType::createTypes()
{
    // Call base class
    IIeeeBaseEthernetPortTypeBase::createTypes();
...
*/
void IIeeeBaseEthernetPortType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeBaseEthernetPortTypeBase::clearStaticMembers();
}
