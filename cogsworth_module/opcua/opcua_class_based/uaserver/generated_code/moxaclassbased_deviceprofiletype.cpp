/******************************************************************************
** moxaclassbased_deviceprofiletype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class DeviceProfileType.
...
: DeviceProfileTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
DeviceProfileType::DeviceProfileType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: DeviceProfileTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class DeviceProfileType with all components.
*/
DeviceProfileType::DeviceProfileType(
...
: DeviceProfileTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void DeviceProfileType::createTypes()
{
    // Call base class
    DeviceProfileTypeBase::createTypes();
...
*/
void DeviceProfileType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    DeviceProfileTypeBase::clearStaticMembers();
}
