/******************************************************************************
** moxaclassbased_restfultype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class RESTfulType.
...
: RESTfulTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
RESTfulType::RESTfulType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: RESTfulTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class RESTfulType with all components.
*/
RESTfulType::RESTfulType(
...
: RESTfulTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void RESTfulType::createTypes()
{
    // Call base class
    RESTfulTypeBase::createTypes();
...
*/
void RESTfulType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    RESTfulTypeBase::clearStaticMembers();
}
