...
/** Construction of the class IVlanIdType.
...
: IVlanIdTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IVlanIdType::IVlanIdType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IVlanIdTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IVlanIdType with all components.
*/
IVlanIdType::IVlanIdType(
...
: IVlanIdTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IVlanIdType::createTypes()
{
    // Call base class
    IVlanIdTypeBase::createTypes();
...
*/
void IVlanIdType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IVlanIdTypeBase::clearStaticMembers();
}
