/******************************************************************************
** moxaclassbased_tsninterfaceconfigurationlistenertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class TsnInterfaceConfigurationListenerType.
 ...
 */
TsnInterfaceConfigurationListenerType::TsnInterfaceConfigurationListenerType(
...
: TsnInterfaceConfigurationListenerTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
TsnInterfaceConfigurationListenerType::TsnInterfaceConfigurationListenerType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: TsnInterfaceConfigurationListenerTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class TsnInterfaceConfigurationListenerType with all components.
*/
TsnInterfaceConfigurationListenerType::TsnInterfaceConfigurationListenerType(
...
: TsnInterfaceConfigurationListenerTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void TsnInterfaceConfigurationListenerType::createTypes()
{
    // Call base class
    TsnInterfaceConfigurationListenerTypeBase::createTypes();
...
*/
void TsnInterfaceConfigurationListenerType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    TsnInterfaceConfigurationListenerTypeBase::clearStaticMembers();
}
