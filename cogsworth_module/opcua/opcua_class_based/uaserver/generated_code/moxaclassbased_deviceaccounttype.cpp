/******************************************************************************
** moxaclassbased_deviceaccounttype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class DeviceAccountType.
 ...
 */
DeviceAccountType::DeviceAccountType(
...
: DeviceAccountTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
DeviceAccountType::DeviceAccountType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: DeviceAccountTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class DeviceAccountType with all components.
*/
DeviceAccountType::DeviceAccountType(
...
: DeviceAccountTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void DeviceAccountType::createTypes()
{
    // Call base class
    DeviceAccountTypeBase::createTypes();
...
*/
void DeviceAccountType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    DeviceAccountTypeBase::clearStaticMembers();
}
