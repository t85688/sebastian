/******************************************************************************
** moxaclassbased_deviceconfigfoldertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class DeviceConfigFolderType.
 ...
 */
DeviceConfigFolderType::DeviceConfigFolderType(
...
: DeviceConfigFolderTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
DeviceConfigFolderType::DeviceConfigFolderType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: DeviceConfigFolderTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class DeviceConfigFolderType with all components.
*/
DeviceConfigFolderType::DeviceConfigFolderType(
...
: DeviceConfigFolderTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void DeviceConfigFolderType::createTypes()
{
    // Call base class
    DeviceConfigFolderTypeBase::createTypes();
...
*/
void DeviceConfigFolderType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    DeviceConfigFolderTypeBase::clearStaticMembers();
}
