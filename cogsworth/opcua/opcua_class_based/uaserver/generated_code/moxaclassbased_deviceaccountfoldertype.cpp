 ...
 */
UaStatus DeviceAccountFolderType::AddDeviceAccount(
 ...
 *  @param[out] ErrorMessage
 */
UaStatus DeviceAccountFolderType::RemoveDeviceAccount(
    const ServiceContext& serviceContext,
 ...
 *  @param[out] ErrorMessage
 */
UaStatus DeviceAccountFolderType::SetDeviceAccount(
    const ServiceContext& serviceContext,
    const MoxaClassBased::DeviceAccountDataType& Configuration,
    OpcUa_UInt32& ErrorCode,
    UaString& ErrorMessage)
