/******************************************************************************
** moxaclassbased_tsninterfaceconfigurationtalkertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class TsnInterfaceConfigurationTalkerType.
 ...
 */
TsnInterfaceConfigurationTalkerType::TsnInterfaceConfigurationTalkerType(
...
: TsnInterfaceConfigurationTalkerTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
TsnInterfaceConfigurationTalkerType::TsnInterfaceConfigurationTalkerType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: TsnInterfaceConfigurationTalkerTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class TsnInterfaceConfigurationTalkerType with all components.
*/
TsnInterfaceConfigurationTalkerType::TsnInterfaceConfigurationTalkerType(
...
: TsnInterfaceConfigurationTalkerTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void TsnInterfaceConfigurationTalkerType::createTypes()
{
    // Call base class
    TsnInterfaceConfigurationTalkerTypeBase::createTypes();
...
*/
void TsnInterfaceConfigurationTalkerType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    TsnInterfaceConfigurationTalkerTypeBase::clearStaticMembers();
}
