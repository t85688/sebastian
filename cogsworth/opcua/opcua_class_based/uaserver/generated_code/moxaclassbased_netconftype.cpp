/******************************************************************************
** moxaclassbased_netconftype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class NETCONFType.
...
: NETCONFTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
NETCONFType::NETCONFType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: NETCONFTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class NETCONFType with all components.
*/
NETCONFType::NETCONFType(
...
: NETCONFTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void NETCONFType::createTypes()
{
    // Call base class
    NETCONFTypeBase::createTypes();
...
*/
void NETCONFType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    NETCONFTypeBase::clearStaticMembers();
}
