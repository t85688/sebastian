/******************************************************************************
** opcuaclassbnm_iieeetsnmacaddresstype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeTsnMacAddressType.
...
: IIeeeTsnMacAddressTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeTsnMacAddressType::IIeeeTsnMacAddressType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeTsnMacAddressTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeTsnMacAddressType with all components.
*/
IIeeeTsnMacAddressType::IIeeeTsnMacAddressType(
...
: IIeeeTsnMacAddressTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeTsnMacAddressType::createTypes()
{
    // Call base class
    IIeeeTsnMacAddressTypeBase::createTypes();
...
*/
void IIeeeTsnMacAddressType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeTsnMacAddressTypeBase::clearStaticMembers();
}
