/******************************************************************************
** moxaclassbased_tsnlistenerstreamtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class TsnListenerStreamType.
 ...
 */
TsnListenerStreamType::TsnListenerStreamType(
...
: TsnListenerStreamTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
TsnListenerStreamType::TsnListenerStreamType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: TsnListenerStreamTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class TsnListenerStreamType with all components.
*/
TsnListenerStreamType::TsnListenerStreamType(
...
: TsnListenerStreamTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void TsnListenerStreamType::createTypes()
{
    // Call base class
    TsnListenerStreamTypeBase::createTypes();
...
*/
void TsnListenerStreamType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    TsnListenerStreamTypeBase::clearStaticMembers();
}
