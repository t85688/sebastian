/******************************************************************************
** opcuaclassbnm_iieeeautonegotiationstatustype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeAutoNegotiationStatusType.
...
: IIeeeAutoNegotiationStatusTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeAutoNegotiationStatusType::IIeeeAutoNegotiationStatusType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeAutoNegotiationStatusTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeAutoNegotiationStatusType with all components.
*/
IIeeeAutoNegotiationStatusType::IIeeeAutoNegotiationStatusType(
...
: IIeeeAutoNegotiationStatusTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeAutoNegotiationStatusType::createTypes()
{
    // Call base class
    IIeeeAutoNegotiationStatusTypeBase::createTypes();
...
*/
void IIeeeAutoNegotiationStatusType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeAutoNegotiationStatusTypeBase::clearStaticMembers();
}
