/******************************************************************************
** moxaclassbased_multicaststaticforwardtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class MulticastStaticForwardType.
 ...
 */
MulticastStaticForwardType::MulticastStaticForwardType(
...
: MulticastStaticForwardTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
MulticastStaticForwardType::MulticastStaticForwardType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: MulticastStaticForwardTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class MulticastStaticForwardType with all components.
*/
MulticastStaticForwardType::MulticastStaticForwardType(
...
: MulticastStaticForwardTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void MulticastStaticForwardType::createTypes()
{
    // Call base class
    MulticastStaticForwardTypeBase::createTypes();
...
*/
void MulticastStaticForwardType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    MulticastStaticForwardTypeBase::clearStaticMembers();
}
