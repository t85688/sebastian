...
OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::s_pDeviceDiscoveredToLinkSequenceDetecting =
    NULL;
...
OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::s_pDeviceDiscoveringToDeviceDiscoveringFailed =
    NULL;
...
OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::s_pLinkSequenceDetectingFailedToIpConfiguring =
    NULL;
OpcUa::TransitionType*
    BroadcastSearchAndIPSettingStateMachineTypeBase::s_pLinkSequenceDetectingFailedToRetryConnection = NULL;
OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::s_pLinkSequenceDetectingToLinkSequenceDetected =
    NULL;
OpcUa::TransitionType*
    BroadcastSearchAndIPSettingStateMachineTypeBase::s_pLinkSequenceDetectingToLinkSequenceDetectingFailed = NULL;
...
BroadcastSearchAndIPSettingStateMachineTypeBase::BroadcastSearchAndIPSettingStateMachineTypeBase(
    const UaNodeId& nodeId, UaObject* pInstanceDeclarationObject, NodeManagerConfig* pNodeConfig,
 ...
 */
BroadcastSearchAndIPSettingStateMachineTypeBase::BroadcastSearchAndIPSettingStateMachineTypeBase(
    const UaNodeId& nodeId, const UaString& name, OpcUa_UInt16 browseNameNameSpaceIndex, NodeManagerConfig* pNodeConfig,
    UaMutexRefCounted* pSharedMutex)
...
BroadcastSearchAndIPSettingStateMachineTypeBase::BroadcastSearchAndIPSettingStateMachineTypeBase(
    UaBase::Object*
        pBaseNode,  //!< [in] The "tree" of nodes that specifies the attributes of the instance and its children
    XmlUaNodeFactoryManager* pFactory,  //!< [in] The factory to create the children
    NodeManagerConfig* pNodeConfig,     //!< [in] Interface pointer to the NodeManagerConfig interface used to add and
                                        //!< delete node and references in the address space
    UaMutexRefCounted* pSharedMutex)    //!< [in] Shared mutex object used to synchronize access to the variable. Can be
                                        //!< NULL if no shared mutex is provided
  ...
  for (std::list<UaBase::BaseNode*>::const_iterator it = lstReferencedNodes.begin(); it != lstReferencedNodes.end();
       it++) {
    UaBase::BaseNode* pChild = *it;
    if (pChild->browseName() ==
        UaQualifiedName("ErrorCode", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pErrorCode) {
        m_pErrorCode = (OpcUa::BaseDataVariableType*)pFactory->createVariable((UaBase::Variable*)pChild, pNodeConfig,
                                                                              pSharedMutex);
        ...
        if (!((UaBase::Variable*)pChild)->modellingRuleId().isNull()) {
          m_pErrorCode->setModellingRuleId(((UaBase::Variable*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("ErrorMessage", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pErrorMessage) {
        m_pErrorMessage = (OpcUa::BaseDataVariableType*)pFactory->createVariable((UaBase::Variable*)pChild, pNodeConfig,
                                                                                 pSharedMutex);
        ...
        if (!((UaBase::Variable*)pChild)->modellingRuleId().isNull()) {
          m_pErrorMessage->setModellingRuleId(((UaBase::Variable*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscovered", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscovered) {
        m_pDeviceDiscovered =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscovered->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscoveredToInit",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscoveredToInit) {
        m_pDeviceDiscoveredToInit =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscoveredToInit->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscoveredToLinkSequenceDetecting",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscoveredToLinkSequenceDetecting) {
        m_pDeviceDiscoveredToLinkSequenceDetecting =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus =
            pNodeConfig->addNodeAndReference(this, m_pDeviceDiscoveredToLinkSequenceDetecting, OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscoveredToLinkSequenceDetecting->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscoveredToRetryConnection",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscoveredToRetryConnection) {
        m_pDeviceDiscoveredToRetryConnection =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscoveredToRetryConnection->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscovering", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscovering) {
        m_pDeviceDiscovering =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscovering->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscoveringFailed",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscoveringFailed) {
        m_pDeviceDiscoveringFailed =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscoveringFailed->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscoveringFailedToInit",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscoveringFailedToInit) {
        m_pDeviceDiscoveringFailedToInit =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscoveringFailedToInit->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscoveringToDeviceDiscovered",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscoveringToDeviceDiscovered) {
        m_pDeviceDiscoveringToDeviceDiscovered =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus =
            pNodeConfig->addNodeAndReference(this, m_pDeviceDiscoveringToDeviceDiscovered, OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscoveringToDeviceDiscovered->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("DeviceDiscoveringToDeviceDiscoveringFailed",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDeviceDiscoveringToDeviceDiscoveringFailed) {
        m_pDeviceDiscoveringToDeviceDiscoveringFailed =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus =
            pNodeConfig->addNodeAndReference(this, m_pDeviceDiscoveringToDeviceDiscoveringFailed, OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDeviceDiscoveringToDeviceDiscoveringFailed->setModellingRuleId(
              ((UaBase::Object*)pChild)->modellingRuleId());
        }
      }
    } else if (pChild->browseName() ==
               UaQualifiedName("DiscoveredDevices", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pDiscoveredDevices) {
        m_pDiscoveredDevices =
            (OpcUa::FolderType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pDiscoveredDevices->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("Init", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pInit) {
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pInit->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("InitToDeviceDiscovering",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pInitToDeviceDiscovering) {
        m_pInitToDeviceDiscovering =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pInitToDeviceDiscovering->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfigured", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfigured) {
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfigured->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfiguredToInit", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfiguredToInit) {
        m_pIpConfiguredToInit =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfiguredToInit->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfiguring", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfiguring) {
        m_pIpConfiguring =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfiguring->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfiguringFailed",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfiguringFailed) {
        m_pIpConfiguringFailed =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfiguringFailed->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfiguringFailedToInit",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfiguringFailedToInit) {
        m_pIpConfiguringFailedToInit =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfiguringFailedToInit->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfiguringFailedToIpConfiguring",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfiguringFailedToIpConfiguring) {
        m_pIpConfiguringFailedToIpConfiguring =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfiguringFailedToIpConfiguring->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfiguringToIpConfigured",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfiguringToIpConfigured) {
        m_pIpConfiguringToIpConfigured =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfiguringToIpConfigured->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("IpConfiguringToIpConfiguringFailed",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pIpConfiguringToIpConfiguringFailed) {
        m_pIpConfiguringToIpConfiguringFailed =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pIpConfiguringToIpConfiguringFailed->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("LinkSequenceDetected",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetected) {
        m_pLinkSequenceDetected =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetected->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("LinkSequenceDetectedToInit",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectedToInit) {
        m_pLinkSequenceDetectedToInit =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectedToInit->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("LinkSequenceDetectedToIpConfiguring",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectedToIpConfiguring) {
        m_pLinkSequenceDetectedToIpConfiguring =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus =
            pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectedToIpConfiguring, OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectedToIpConfiguring->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("LinkSequenceDetecting",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetecting) {
        m_pLinkSequenceDetecting =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetecting->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("LinkSequenceDetectingFailed",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectingFailed) {
        m_pLinkSequenceDetectingFailed =
            (OpcUa::StateType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectingFailed->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("LinkSequenceDetectingFailedToInit",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectingFailedToInit) {
        m_pLinkSequenceDetectingFailedToInit =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectingFailedToInit->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("LinkSequenceDetectingFailedToIpConfiguring",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectingFailedToIpConfiguring) {
        m_pLinkSequenceDetectingFailedToIpConfiguring =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus =
            pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingFailedToIpConfiguring, OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectingFailedToIpConfiguring->setModellingRuleId(
              ((UaBase::Object*)pChild)->modellingRuleId());
        }
      }
    } else if (pChild->browseName() ==
               UaQualifiedName("LinkSequenceDetectingFailedToRetryConnection",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectingFailedToRetryConnection) {
        m_pLinkSequenceDetectingFailedToRetryConnection =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus = pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingFailedToRetryConnection,
                                                     OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectingFailedToRetryConnection->setModellingRuleId(
              ((UaBase::Object*)pChild)->modellingRuleId());
        }
      }
    } else if (pChild->browseName() ==
               UaQualifiedName("LinkSequenceDetectingToLinkSequenceDetected",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectingToLinkSequenceDetected) {
        m_pLinkSequenceDetectingToLinkSequenceDetected =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus = pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingToLinkSequenceDetected,
                                                     OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectingToLinkSequenceDetected->setModellingRuleId(
              ((UaBase::Object*)pChild)->modellingRuleId());
        }
      }
    } else if (pChild->browseName() ==
               UaQualifiedName("LinkSequenceDetectingToLinkSequenceDetectingFailed",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pLinkSequenceDetectingToLinkSequenceDetectingFailed) {
        m_pLinkSequenceDetectingToLinkSequenceDetectingFailed =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
        addStatus = pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingToLinkSequenceDetectingFailed,
                                                     OpcUaId_HasComponent);
        UA_ASSERT(addStatus.isGood());
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pLinkSequenceDetectingToLinkSequenceDetectingFailed->setModellingRuleId(
              ((UaBase::Object*)pChild)->modellingRuleId());
        }
      }
    } else if (pChild->browseName() ==
               UaQualifiedName("RetryConnection", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pRetryConnection) {
        ...
        if (!((UaBase::Object*)pChild)->modellingRuleId().isNull()) {
          m_pRetryConnection->setModellingRuleId(((UaBase::Object*)pChild)->modellingRuleId());
               ...
               UaQualifiedName("RetryConnectionToDeviceDiscovered",
                               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace())) {
      if (!m_pRetryConnectionToDeviceDiscovered) {
        m_pRetryConnectionToDeviceDiscovered =
            (OpcUa::TransitionType*)pFactory->createObject((UaBase::Object*)pChild, pNodeConfig, pSharedMutex);
      ...
      if (!m_pGetDiscoveredDevicesMethod) {
        m_pGetDiscoveredDevicesMethod =
            (OpcUa::BaseMethod*)pFactory->createMethod((UaBase::Method*)pChild, pNodeConfig, pSharedMutex);
    ...
    } else if (s_pStartLinkSequenceDetectMethod &&
               pChild->browseName() == s_pStartLinkSequenceDetectMethod->browseName()) {
      if (!m_pStartLinkSequenceDetectMethod) {
        m_pStartLinkSequenceDetectMethod =
            (OpcUa::BaseMethod*)pFactory->createMethod((UaBase::Method*)pChild, pNodeConfig, pSharedMutex);
...
void BroadcastSearchAndIPSettingStateMachineTypeBase::initialize() {
  ...
  m_pDeviceDiscovered = new OpcUa::StateType(UaNodeId(UaString("%1.DeviceDiscovered").arg(nodeId().toString()), nsIdx),
                                             s_pDeviceDiscovered, m_pNodeConfig, m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pDeviceDiscovered, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object DeviceDiscoveredToInit
  m_pDeviceDiscoveredToInit =
      new OpcUa::TransitionType(UaNodeId(UaString("%1.DeviceDiscoveredToInit").arg(nodeId().toString()), nsIdx),
                                s_pDeviceDiscoveredToInit, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pDeviceDiscoveredToLinkSequenceDetecting = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.DeviceDiscoveredToLinkSequenceDetecting").arg(nodeId().toString()), nsIdx),
      s_pDeviceDiscoveredToLinkSequenceDetecting, m_pNodeConfig, m_pSharedMutex);
  addStatus =
      m_pNodeConfig->addNodeAndReference(this, m_pDeviceDiscoveredToLinkSequenceDetecting, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object DeviceDiscoveredToRetryConnection
  m_pDeviceDiscoveredToRetryConnection = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.DeviceDiscoveredToRetryConnection").arg(nodeId().toString()), nsIdx),
      s_pDeviceDiscoveredToRetryConnection, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pDeviceDiscovering =
      new OpcUa::StateType(UaNodeId(UaString("%1.DeviceDiscovering").arg(nodeId().toString()), nsIdx),
                           s_pDeviceDiscovering, m_pNodeConfig, m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pDeviceDiscovering, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object DeviceDiscoveringFailed
  m_pDeviceDiscoveringFailed =
      new OpcUa::StateType(UaNodeId(UaString("%1.DeviceDiscoveringFailed").arg(nodeId().toString()), nsIdx),
                           s_pDeviceDiscoveringFailed, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pDeviceDiscoveringFailedToInit =
      new OpcUa::TransitionType(UaNodeId(UaString("%1.DeviceDiscoveringFailedToInit").arg(nodeId().toString()), nsIdx),
                                s_pDeviceDiscoveringFailedToInit, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pDeviceDiscoveringToDeviceDiscovered = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.DeviceDiscoveringToDeviceDiscovered").arg(nodeId().toString()), nsIdx),
      s_pDeviceDiscoveringToDeviceDiscovered, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pDeviceDiscoveringToDeviceDiscoveringFailed = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.DeviceDiscoveringToDeviceDiscoveringFailed").arg(nodeId().toString()), nsIdx),
      s_pDeviceDiscoveringToDeviceDiscoveringFailed, m_pNodeConfig, m_pSharedMutex);
  addStatus =
      m_pNodeConfig->addNodeAndReference(this, m_pDeviceDiscoveringToDeviceDiscoveringFailed, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object DiscoveredDevices
  m_pDiscoveredDevices =
      new OpcUa::FolderType(UaNodeId(UaString("%1.DiscoveredDevices").arg(nodeId().toString()), nsIdx),
                            s_pDiscoveredDevices, m_pNodeConfig, m_pSharedMutex);
  ...
  // Object Init
  m_pInit = new OpcUa::StateType(UaNodeId(UaString("%1.Init").arg(nodeId().toString()), nsIdx), s_pInit, m_pNodeConfig,
                                 m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pInit, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object InitToDeviceDiscovering
  m_pInitToDeviceDiscovering =
      new OpcUa::TransitionType(UaNodeId(UaString("%1.InitToDeviceDiscovering").arg(nodeId().toString()), nsIdx),
                                s_pInitToDeviceDiscovering, m_pNodeConfig, m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pInitToDeviceDiscovering, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object IpConfigured
  m_pIpConfigured = new OpcUa::StateType(UaNodeId(UaString("%1.IpConfigured").arg(nodeId().toString()), nsIdx),
                                         s_pIpConfigured, m_pNodeConfig, m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pIpConfigured, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object IpConfiguredToInit
  m_pIpConfiguredToInit =
      new OpcUa::TransitionType(UaNodeId(UaString("%1.IpConfiguredToInit").arg(nodeId().toString()), nsIdx),
                                s_pIpConfiguredToInit, m_pNodeConfig, m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pIpConfiguredToInit, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object IpConfiguring
  m_pIpConfiguring = new OpcUa::StateType(UaNodeId(UaString("%1.IpConfiguring").arg(nodeId().toString()), nsIdx),
                                          s_pIpConfiguring, m_pNodeConfig, m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pIpConfiguring, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object IpConfiguringFailed
  m_pIpConfiguringFailed =
      new OpcUa::StateType(UaNodeId(UaString("%1.IpConfiguringFailed").arg(nodeId().toString()), nsIdx),
                           s_pIpConfiguringFailed, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pIpConfiguringFailedToInit =
      new OpcUa::TransitionType(UaNodeId(UaString("%1.IpConfiguringFailedToInit").arg(nodeId().toString()), nsIdx),
                                s_pIpConfiguringFailedToInit, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pIpConfiguringFailedToIpConfiguring = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.IpConfiguringFailedToIpConfiguring").arg(nodeId().toString()), nsIdx),
      s_pIpConfiguringFailedToIpConfiguring, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pIpConfiguringToIpConfigured =
      new OpcUa::TransitionType(UaNodeId(UaString("%1.IpConfiguringToIpConfigured").arg(nodeId().toString()), nsIdx),
                                s_pIpConfiguringToIpConfigured, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pIpConfiguringToIpConfiguringFailed = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.IpConfiguringToIpConfiguringFailed").arg(nodeId().toString()), nsIdx),
      s_pIpConfiguringToIpConfiguringFailed, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pLinkSequenceDetected =
      new OpcUa::StateType(UaNodeId(UaString("%1.LinkSequenceDetected").arg(nodeId().toString()), nsIdx),
                           s_pLinkSequenceDetected, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pLinkSequenceDetectedToInit =
      new OpcUa::TransitionType(UaNodeId(UaString("%1.LinkSequenceDetectedToInit").arg(nodeId().toString()), nsIdx),
                                s_pLinkSequenceDetectedToInit, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pLinkSequenceDetectedToIpConfiguring = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.LinkSequenceDetectedToIpConfiguring").arg(nodeId().toString()), nsIdx),
      s_pLinkSequenceDetectedToIpConfiguring, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pLinkSequenceDetecting =
      new OpcUa::StateType(UaNodeId(UaString("%1.LinkSequenceDetecting").arg(nodeId().toString()), nsIdx),
                           s_pLinkSequenceDetecting, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pLinkSequenceDetectingFailed =
      new OpcUa::StateType(UaNodeId(UaString("%1.LinkSequenceDetectingFailed").arg(nodeId().toString()), nsIdx),
                           s_pLinkSequenceDetectingFailed, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pLinkSequenceDetectingFailedToInit = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.LinkSequenceDetectingFailedToInit").arg(nodeId().toString()), nsIdx),
      s_pLinkSequenceDetectingFailedToInit, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pLinkSequenceDetectingFailedToIpConfiguring = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.LinkSequenceDetectingFailedToIpConfiguring").arg(nodeId().toString()), nsIdx),
      s_pLinkSequenceDetectingFailedToIpConfiguring, m_pNodeConfig, m_pSharedMutex);
  addStatus =
      m_pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingFailedToIpConfiguring, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object LinkSequenceDetectingFailedToRetryConnection
  m_pLinkSequenceDetectingFailedToRetryConnection = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.LinkSequenceDetectingFailedToRetryConnection").arg(nodeId().toString()), nsIdx),
      s_pLinkSequenceDetectingFailedToRetryConnection, m_pNodeConfig, m_pSharedMutex);
  addStatus =
      m_pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingFailedToRetryConnection, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object LinkSequenceDetectingToLinkSequenceDetected
  m_pLinkSequenceDetectingToLinkSequenceDetected = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.LinkSequenceDetectingToLinkSequenceDetected").arg(nodeId().toString()), nsIdx),
      s_pLinkSequenceDetectingToLinkSequenceDetected, m_pNodeConfig, m_pSharedMutex);
  addStatus =
      m_pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingToLinkSequenceDetected, OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object LinkSequenceDetectingToLinkSequenceDetectingFailed
  m_pLinkSequenceDetectingToLinkSequenceDetectingFailed = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.LinkSequenceDetectingToLinkSequenceDetectingFailed").arg(nodeId().toString()), nsIdx),
      s_pLinkSequenceDetectingToLinkSequenceDetectingFailed, m_pNodeConfig, m_pSharedMutex);
  addStatus = m_pNodeConfig->addNodeAndReference(this, m_pLinkSequenceDetectingToLinkSequenceDetectingFailed,
                                                 OpcUaId_HasComponent);
  UA_ASSERT(addStatus.isGood());
  // Object RetryConnection
  m_pRetryConnection = new OpcUa::StateType(UaNodeId(UaString("%1.RetryConnection").arg(nodeId().toString()), nsIdx),
                                            s_pRetryConnection, m_pNodeConfig, m_pSharedMutex);
  ...
  m_pRetryConnectionToDeviceDiscovered = new OpcUa::TransitionType(
      UaNodeId(UaString("%1.RetryConnectionToDeviceDiscovered").arg(nodeId().toString()), nsIdx),
      s_pRetryConnectionToDeviceDiscovered, m_pNodeConfig, m_pSharedMutex);
  ...
  pPropertyArg = new UaPropertyMethodArgument(
      UaNodeId(UaString("%1.GetDiscoveredDevices.OutputArguments").arg(nodeId().toString()),
  ...
  pPropertyArg->setArgument(
      ...
      UaNodeId(MoxaClassBasedId_DiscoveredDeviceDataType,
               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()),  // Data type of the argument
      1,                                                                          // ValueRank of the argument
      arrayDimensions, UaLocalizedText("", ""));                                  // Description
  ...
  // Create property
  pPropertyArg =
      new UaPropertyMethodArgument(UaNodeId(UaString("%1.StartDeviceDiscovery.InputArguments").arg(nodeId().toString()),
                                            nsIdx),                         // NodeId of the property
                                   OpcUa_AccessLevels_CurrentRead,          // Access level of the property
                                   1,                                       // Number of arguments
  ...
  pPropertyArg->setArgument(
      ...
      UaNodeId(MoxaClassBasedId_DeviceDiscoveryDataType,
               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()),  // Data type of the argument
      -1,                                                                         // ValueRank of the argument
      arrayDimensions, UaLocalizedText("", ""));                                  // Description
  // Add property to method
  ...
  // Create property
  pPropertyArg =
      new UaPropertyMethodArgument(UaNodeId(UaString("%1.StartIpConfigure.InputArguments").arg(nodeId().toString()),
                                            nsIdx),                         // NodeId of the property
                                   OpcUa_AccessLevels_CurrentRead,          // Access level of the property
                                   1,                                       // Number of arguments
                                   UaPropertyMethodArgument::INARGUMENTS);  // IN arguments
  ...
  pPropertyArg->setArgument(
      0,                // Index of the argument
      "Configuration",  // Name of the argument
      UaNodeId(MoxaClassBasedId_IpConfigureDataType,
               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()),  // Data type of the argument
      1,                                                                          // ValueRank of the argument
      arrayDimensions, UaLocalizedText("", ""));                                  // Description
  // Add property to method
  ...
  // Create property
  pPropertyArg =
      new UaPropertyMethodArgument(UaNodeId(UaString("%1.StartRetryConnection.InputArguments").arg(nodeId().toString()),
                                            nsIdx),                         // NodeId of the property
                                   OpcUa_AccessLevels_CurrentRead,          // Access level of the property
  ...
  pPropertyArg->setArgument(
      ...
      UaNodeId(MoxaClassBasedId_SNMPDataType,
               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()),  // Data type of the argument
      -1,                                                                         // ValueRank of the argument
      arrayDimensions, UaLocalizedText("", ""));                                  // Description
  // Argument RESTful
  pPropertyArg->setArgument(
      ...
      UaNodeId(MoxaClassBasedId_RESTfulDataType,
               MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()),  // Data type of the argument
      -1,                                                                         // ValueRank of the argument
      arrayDimensions, UaLocalizedText("", ""));                                  // Description
  // Add property to method
...
void BroadcastSearchAndIPSettingStateMachineTypeBase::createTypes() {
  if (s_typeNodesCreated == false) {
    ...
    pObjectType = new OpcUa::GenericObjectType(
        ...
        UaLocalizedText("", "BroadcastSearchAndIPSettingStateMachineType"), UaLocalizedText("", ""), OpcUa_False,
        &BroadcastSearchAndIPSettingStateMachineType::clearStaticMembers);
    addStatus = pTypeNodeConfig->addNodeAndReference(UaNodeId(OpcUaId_FiniteStateMachineType, nsSuperTypeIdx),
                                                     pObjectType, OpcUaId_HasSubtype);
    UA_ASSERT(addStatus.isGood());
    // ------------------------------------------------------------------------
    // Method GetDiscoveredDevices
    // ------------------------------------------------------------------------
    s_pGetDiscoveredDevicesMethod = new OpcUa::BaseMethod(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_GetDiscoveredDevices, nsTypeIdx),
        "GetDiscoveredDevices", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace());
    ...
    // Create property
    pPropertyArg = new UaPropertyMethodArgument(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_GetDiscoveredDevices_OutputArguments,
                 nsTypeIdx),                      // NodeId of the property
        OpcUa_AccessLevels_CurrentRead,           // Access level of the property
        1,                                        // Number of arguments
        UaPropertyMethodArgument::OUTARGUMENTS);  // OUT arguments
    // Argument DiscoveredDevices
    ...
    // Method StartDeviceDiscovery
    // ------------------------------------------------------------------------
    s_pStartDeviceDiscoveryMethod = new OpcUa::BaseMethod(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartDeviceDiscovery, nsTypeIdx),
        "StartDeviceDiscovery", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace());
    ...
    // Create property
    pPropertyArg = new UaPropertyMethodArgument(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartDeviceDiscovery_InputArguments,
                 nsTypeIdx),                     // NodeId of the property
        OpcUa_AccessLevels_CurrentRead,          // Access level of the property
        1,                                       // Number of arguments
        UaPropertyMethodArgument::INARGUMENTS);  // IN arguments
    ...
    // Method StartInit
    // ------------------------------------------------------------------------
    s_pStartInitMethod = new OpcUa::BaseMethod(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartInit, nsTypeIdx), "StartInit",
        MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace());
    ...
    // Method StartIpConfigure
    // ------------------------------------------------------------------------
    s_pStartIpConfigureMethod = new OpcUa::BaseMethod(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartIpConfigure, nsTypeIdx),
        "StartIpConfigure", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace());
    ...
    // Create property
    pPropertyArg = new UaPropertyMethodArgument(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartIpConfigure_InputArguments,
                 nsTypeIdx),                     // NodeId of the property
        OpcUa_AccessLevels_CurrentRead,          // Access level of the property
        1,                                       // Number of arguments
        UaPropertyMethodArgument::INARGUMENTS);  // IN arguments
    ...
    // Method StartLinkSequenceDetect
    // ------------------------------------------------------------------------
    s_pStartLinkSequenceDetectMethod = new OpcUa::BaseMethod(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartLinkSequenceDetect, nsTypeIdx),
        "StartLinkSequenceDetect", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace());
    s_pStartLinkSequenceDetectMethod->setModellingRuleId(OpcUaId_ModellingRule_Mandatory);
    addStatus =
        pTypeNodeConfig->addNodeAndReference(pObjectType, s_pStartLinkSequenceDetectMethod, OpcUaId_HasComponent);
    UA_ASSERT(addStatus.isGood());

    // ------------------------------------------------------------------------
    // Method StartRetryConnection
    // ------------------------------------------------------------------------
    s_pStartRetryConnectionMethod = new OpcUa::BaseMethod(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartRetryConnection, nsTypeIdx),
        "StartRetryConnection", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace());
    ...
    // Create property
    pPropertyArg = new UaPropertyMethodArgument(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_StartRetryConnection_InputArguments,
                 nsTypeIdx),                     // NodeId of the property
        OpcUa_AccessLevels_CurrentRead,          // Access level of the property
        2,                                       // Number of arguments
        UaPropertyMethodArgument::INARGUMENTS);  // IN arguments
...

    {
      ...
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscovered, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("DeviceDiscovered", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscovered"));
      {
        ...
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscovered_StateNumber, nsTypeIdx));
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveredToInit, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("DeviceDiscoveredToInit", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscoveredToInit"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveredToInit_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveredToLinkSequenceDetecting,
                   nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("DeviceDiscoveredToLinkSequenceDetecting",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscoveredToLinkSequenceDetecting"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveredToLinkSequenceDetecting_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pDeviceDiscoveredToLinkSequenceDetecting,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
    ...
    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveredToRetryConnection, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("DeviceDiscoveredToRetryConnection",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscoveredToRetryConnection"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveredToRetryConnection_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus =
          pTypeNodeConfig->addNodeAndReference(pObjectType, s_pDeviceDiscoveredToRetryConnection, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscovering, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("DeviceDiscovering", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscovering"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscovering_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringFailed, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("DeviceDiscoveringFailed", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscoveringFailed"));
      {
        UaBase::BaseNode* pParent = pChild;
        UaBase::BaseNode* pChild2;
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(
            UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringFailed_StateNumber,
                     nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringFailedToInit, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("DeviceDiscoveringFailedToInit",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscoveringFailedToInit"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringFailedToInit_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus =
          pTypeNodeConfig->addNodeAndReference(pObjectType, s_pDeviceDiscoveringFailedToInit, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringToDeviceDiscovered, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("DeviceDiscoveringToDeviceDiscovered",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscoveringToDeviceDiscovered"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringToDeviceDiscovered_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pDeviceDiscoveringToDeviceDiscovered,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringToDeviceDiscoveringFailed,
          nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("DeviceDiscoveringToDeviceDiscoveringFailed",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "DeviceDiscoveringToDeviceDiscoveringFailed"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DeviceDiscoveringToDeviceDiscoveringFailed_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      s_pDeviceDiscoveringToDeviceDiscoveringFailed =
          new OpcUa::TransitionType(pChild, &factory, pTypeNodeConfig, NULL);
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pDeviceDiscoveringToDeviceDiscoveringFailed,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
    ...
    // Object DiscoveredDevices
    s_pDiscoveredDevices = new OpcUa::FolderType(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_DiscoveredDevices, nsTypeIdx),
        "DiscoveredDevices", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace(), pTypeNodeConfig);
    ...
    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild =
          new UaBase::Object(UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_Init, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      ...
      pChild->setDisplayName(UaLocalizedText("", "Init"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(
            UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_Init_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_InitToDeviceDiscovering, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("InitToDeviceDiscovering", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "InitToDeviceDiscovering"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_InitToDeviceDiscovering_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfigured, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("IpConfigured", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfigured"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(
            UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfigured_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguredToInit, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("IpConfiguredToInit", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfiguredToInit"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(
            UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguredToInit_TransitionNumber,
                     nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguring, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("IpConfiguring", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfiguring"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguring_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringFailed, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("IpConfiguringFailed", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfiguringFailed"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringFailed_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringFailedToInit, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("IpConfiguringFailedToInit",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfiguringFailedToInit"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringFailedToInit_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringFailedToIpConfiguring, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("IpConfiguringFailedToIpConfiguring",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfiguringFailedToIpConfiguring"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringFailedToIpConfiguring_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pIpConfiguringFailedToIpConfiguring,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringToIpConfigured, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("IpConfiguringToIpConfigured",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfiguringToIpConfigured"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringToIpConfigured_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus =
          pTypeNodeConfig->addNodeAndReference(pObjectType, s_pIpConfiguringToIpConfigured, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringToIpConfiguringFailed, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("IpConfiguringToIpConfiguringFailed",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "IpConfiguringToIpConfiguringFailed"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_IpConfiguringToIpConfiguringFailed_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pIpConfiguringToIpConfiguringFailed,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetected, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("LinkSequenceDetected", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetected"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetected_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectedToInit, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectedToInit",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectedToInit"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectedToInit_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus =
          pTypeNodeConfig->addNodeAndReference(pObjectType, s_pLinkSequenceDetectedToInit, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectedToIpConfiguring, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectedToIpConfiguring",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectedToIpConfiguring"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectedToIpConfiguring_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pLinkSequenceDetectedToIpConfiguring,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetecting, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("LinkSequenceDetecting", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetecting"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetecting_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailed, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectingFailed",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectingFailed"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailed_StateNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
      ...
      addStatus =
          pTypeNodeConfig->addNodeAndReference(pObjectType, s_pLinkSequenceDetectingFailed, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailedToInit, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectingFailedToInit",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectingFailedToInit"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailedToInit_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus =
          pTypeNodeConfig->addNodeAndReference(pObjectType, s_pLinkSequenceDetectingFailedToInit, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailedToIpConfiguring,
          nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectingFailedToIpConfiguring",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectingFailedToIpConfiguring"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailedToIpConfiguring_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      s_pLinkSequenceDetectingFailedToIpConfiguring =
          new OpcUa::TransitionType(pChild, &factory, pTypeNodeConfig, NULL);
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pLinkSequenceDetectingFailedToIpConfiguring,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailedToRetryConnection,
          nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectingFailedToRetryConnection",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectingFailedToRetryConnection"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingFailedToRetryConnection_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      s_pLinkSequenceDetectingFailedToRetryConnection =
          new OpcUa::TransitionType(pChild, &factory, pTypeNodeConfig, NULL);
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pLinkSequenceDetectingFailedToRetryConnection,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingToLinkSequenceDetected,
          nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectingToLinkSequenceDetected",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectingToLinkSequenceDetected"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingToLinkSequenceDetected_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      s_pLinkSequenceDetectingToLinkSequenceDetected =
          new OpcUa::TransitionType(pChild, &factory, pTypeNodeConfig, NULL);
      addStatus = pTypeNodeConfig->addNodeAndReference(pObjectType, s_pLinkSequenceDetectingToLinkSequenceDetected,
                                                       OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingToLinkSequenceDetectingFailed,
          nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("LinkSequenceDetectingToLinkSequenceDetectingFailed",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "LinkSequenceDetectingToLinkSequenceDetectingFailed"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_LinkSequenceDetectingToLinkSequenceDetectingFailed_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      s_pLinkSequenceDetectingToLinkSequenceDetectingFailed =
          new OpcUa::TransitionType(pChild, &factory, pTypeNodeConfig, NULL);
      addStatus = pTypeNodeConfig->addNodeAndReference(
          pObjectType, s_pLinkSequenceDetectingToLinkSequenceDetectingFailed, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(
          UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_RetryConnection, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(
          UaQualifiedName("RetryConnection", MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "RetryConnection"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_RetryConnection_StateNumber, nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("StateNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "StateNumber"));
        ((UaBase::Variable*)pChild2)->setAccessLevel(1);
...

    {
      std::list<UaBase::BaseNode*> lstBaseNodes;
      UaBase::Object* pChild = new UaBase::Object(UaNodeId(
          MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_RetryConnectionToDeviceDiscovered, nsTypeIdx));
      lstBaseNodes.push_back(pChild);
      pChild->setBrowseName(UaQualifiedName("RetryConnectionToDeviceDiscovered",
                                            MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace()));
      pChild->setDisplayName(UaLocalizedText("", "RetryConnectionToDeviceDiscovered"));
      {
        ...
        UaBase::FullReference reference;
        pChild2 = new UaBase::Variable(UaNodeId(
            MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_RetryConnectionToDeviceDiscovered_TransitionNumber,
            nsTypeIdx));
        lstBaseNodes.push_back(pChild2);
        pChild2->setBrowseName(UaQualifiedName("TransitionNumber", 0));
        pChild2->setDisplayName(UaLocalizedText("", "TransitionNumber"));
      ...
      addStatus =
          pTypeNodeConfig->addNodeAndReference(pObjectType, s_pRetryConnectionToDeviceDiscovered, OpcUaId_HasComponent);
      UA_ASSERT(addStatus.isGood());
    ...
    s_pErrorCode = new OpcUa::BaseDataVariableType(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_ErrorCode, nsTypeIdx), "ErrorCode",
        MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace(), defaultValue, 3, pTypeNodeConfig);
    ...
    s_pErrorMessage = new OpcUa::BaseDataVariableType(
        UaNodeId(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType_ErrorMessage, nsTypeIdx), "ErrorMessage",
        MoxaClassBased::NodeManagerMoxaClassBasedNS::getTypeNamespace(), defaultValue, 3, pTypeNodeConfig);
...
UaNodeId BroadcastSearchAndIPSettingStateMachineTypeBase::typeDefinitionId() const {
  UaNodeId ret(MoxaClassBasedId_BroadcastSearchAndIPSettingStateMachineType,
               NodeManagerMoxaClassBasedNS::getTypeNamespace());
  return ret;
}

/** Implementation of the MethodManager interface method beginCall
 */
UaStatus BroadcastSearchAndIPSettingStateMachineTypeBase::beginCall(MethodManagerCallback* pCallback,
...
UaStatus BroadcastSearchAndIPSettingStateMachineTypeBase::call(
    const ServiceContext& serviceContext, MethodHandle* pMethodHandle, const UaVariantArray& inputArguments,
    UaVariantArray& outputArguments, UaStatusCodeArray& inputArgumentResults, UaDiagnosticInfos& inputArgumentDiag) {
  UaStatus ret;
  ...
  if (pMethodHandleUaNode) {
    ...
    if (pMethod) {
      if (((m_pGetDiscoveredDevicesMethod != NULL) && (pMethod->nodeId() == m_pGetDiscoveredDevicesMethod->nodeId())) ||
      ...
      } else if (((m_pStartDeviceDiscoveryMethod != NULL) &&
                  (pMethod->nodeId() == m_pStartDeviceDiscoveryMethod->nodeId())) ||
                 ((s_pStartDeviceDiscoveryMethod != NULL) &&
                  (pMethod->nodeId() == s_pStartDeviceDiscoveryMethod->nodeId()))) {
      ...
      } else if (((m_pStartLinkSequenceDetectMethod != NULL) &&
                  (pMethod->nodeId() == m_pStartLinkSequenceDetectMethod->nodeId())) ||
                 ((s_pStartLinkSequenceDetectMethod != NULL) &&
                  (pMethod->nodeId() == s_pStartLinkSequenceDetectMethod->nodeId()))) {
        if (inputArguments.length() > 0) {
          ret = OpcUa_BadTooManyArguments;
        } else {
      ...
      } else if (((m_pStartRetryConnectionMethod != NULL) &&
                  (pMethod->nodeId() == m_pStartRetryConnectionMethod->nodeId())) ||
                 ((s_pStartRetryConnectionMethod != NULL) &&
                  (pMethod->nodeId() == s_pStartRetryConnectionMethod->nodeId()))) {
        ...
        return FiniteStateMachineType::call(serviceContext, pMethodHandle, inputArguments, outputArguments,
                                            inputArgumentResults, inputArgumentDiag);
      }
    } else {
      assert(false);
 ...
 */
OpcUa::StateType* BroadcastSearchAndIPSettingStateMachineTypeBase::getDeviceDiscovered() { return m_pDeviceDiscovered; }
...
/** Returns the DeviceDiscoveredToLinkSequenceDetecting node.
 */
const OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getDeviceDiscoveredToLinkSequenceDetecting() const {
  return m_pDeviceDiscoveredToLinkSequenceDetecting;
}
...
/** Returns the DeviceDiscoveredToRetryConnection node.
 */
const OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::getDeviceDiscoveredToRetryConnection()
    const {
  return m_pDeviceDiscoveredToRetryConnection;
}
...
/** Returns the DeviceDiscoveringToDeviceDiscovered node.
 */
const OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::getDeviceDiscoveringToDeviceDiscovered()
    const {
  return m_pDeviceDiscoveringToDeviceDiscovered;
}
 ...
 */
OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getDeviceDiscoveringToDeviceDiscoveringFailed() {
 ...
 */
const OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getDeviceDiscoveringToDeviceDiscoveringFailed() const {
  return m_pDeviceDiscoveringToDeviceDiscoveringFailed;
}
 ...
 */
OpcUa::StateType* BroadcastSearchAndIPSettingStateMachineTypeBase::getInit() { return m_pInit; }

/** Returns the Init node.
 */
const OpcUa::StateType* BroadcastSearchAndIPSettingStateMachineTypeBase::getInit() const { return m_pInit; }
 ...
 */
OpcUa::StateType* BroadcastSearchAndIPSettingStateMachineTypeBase::getIpConfigured() { return m_pIpConfigured; }
 ...
 */
OpcUa::StateType* BroadcastSearchAndIPSettingStateMachineTypeBase::getIpConfiguring() { return m_pIpConfiguring; }
...
/** Returns the IpConfiguringFailedToIpConfiguring node.
 */
const OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::getIpConfiguringFailedToIpConfiguring()
    const {
  return m_pIpConfiguringFailedToIpConfiguring;
}
...
/** Returns the IpConfiguringToIpConfiguringFailed node.
 */
const OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::getIpConfiguringToIpConfiguringFailed()
    const {
  return m_pIpConfiguringToIpConfiguringFailed;
}
...
/** Returns the LinkSequenceDetectedToIpConfiguring node.
 */
const OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::getLinkSequenceDetectedToIpConfiguring()
    const {
  return m_pLinkSequenceDetectedToIpConfiguring;
}
...
/** Returns the LinkSequenceDetectingFailedToInit node.
 */
const OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::getLinkSequenceDetectingFailedToInit()
    const {
  return m_pLinkSequenceDetectingFailedToInit;
}
 ...
 */
OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getLinkSequenceDetectingFailedToIpConfiguring() {
 ...
 */
const OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getLinkSequenceDetectingFailedToIpConfiguring() const {
  return m_pLinkSequenceDetectingFailedToIpConfiguring;
}
 ...
 */
const OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getLinkSequenceDetectingFailedToRetryConnection() const {
  return m_pLinkSequenceDetectingFailedToRetryConnection;
}
 ...
 */
const OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getLinkSequenceDetectingToLinkSequenceDetected() const {
  return m_pLinkSequenceDetectingToLinkSequenceDetected;
}
 ...
 */
const OpcUa::TransitionType*
BroadcastSearchAndIPSettingStateMachineTypeBase::getLinkSequenceDetectingToLinkSequenceDetectingFailed() const {
  return m_pLinkSequenceDetectingToLinkSequenceDetectingFailed;
}

/** Returns the RetryConnection node.
 */
OpcUa::StateType* BroadcastSearchAndIPSettingStateMachineTypeBase::getRetryConnection() { return m_pRetryConnection; }
...
/** Returns the RetryConnectionToDeviceDiscovered node.
 */
const OpcUa::TransitionType* BroadcastSearchAndIPSettingStateMachineTypeBase::getRetryConnectionToDeviceDiscovered()
    const {
  return m_pRetryConnectionToDeviceDiscovered;
}
 ...
 */
OpcUa::BaseMethod* BroadcastSearchAndIPSettingStateMachineTypeBase::getStartInit() { return m_pStartInitMethod; }
...
void BroadcastSearchAndIPSettingStateMachineTypeBase::useAccessInfoFromInstance(
    BroadcastSearchAndIPSettingStateMachineTypeBase* pOther) {
  ...
  m_pDeviceDiscoveredToLinkSequenceDetecting->useAccessInfoFromInstance(
      pOther->m_pDeviceDiscoveredToLinkSequenceDetecting);
  ...
  m_pDeviceDiscoveringToDeviceDiscoveringFailed->useAccessInfoFromInstance(
      pOther->m_pDeviceDiscoveringToDeviceDiscoveringFailed);
  ...
  m_pLinkSequenceDetectingFailedToIpConfiguring->useAccessInfoFromInstance(
      pOther->m_pLinkSequenceDetectingFailedToIpConfiguring);
  m_pLinkSequenceDetectingFailedToRetryConnection->useAccessInfoFromInstance(
      pOther->m_pLinkSequenceDetectingFailedToRetryConnection);
  m_pLinkSequenceDetectingToLinkSequenceDetected->useAccessInfoFromInstance(
      pOther->m_pLinkSequenceDetectingToLinkSequenceDetected);
  m_pLinkSequenceDetectingToLinkSequenceDetectingFailed->useAccessInfoFromInstance(
      pOther->m_pLinkSequenceDetectingToLinkSequenceDetectingFailed);
...
UaStatus BroadcastSearchAndIPSettingStateMachineTypeBase::setBroadcastSearchAndIPSettingState(
    BroadcastSearchAndIPSettingStateMachineTypeBase::BroadcastSearchAndIPSettingState state) {
  ...
  switch (currentState) {
    case Init:
      switch (state) {
        case DeviceDiscovering:
          ltTransition = s_pInitToDeviceDiscovering->displayName(NULL);
          currentTransitionId = s_pInitToDeviceDiscovering->nodeId();
          setCurrentState(s_pDeviceDiscovering->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pDeviceDiscovering->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
          }
          return OpcUa_Good;
        default:
          break;
    ...
    case DeviceDiscovering:
      switch (state) {
        case DeviceDiscovered:
          ltTransition = s_pDeviceDiscoveringToDeviceDiscovered->displayName(NULL);
          currentTransitionId = s_pDeviceDiscoveringToDeviceDiscovered->nodeId();
          setCurrentState(s_pDeviceDiscovered->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pDeviceDiscovered->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
        ...
        case DeviceDiscoveringFailed:
          ltTransition = s_pDeviceDiscoveringToDeviceDiscoveringFailed->displayName(NULL);
          currentTransitionId = s_pDeviceDiscoveringToDeviceDiscoveringFailed->nodeId();
          setCurrentState(s_pDeviceDiscoveringFailed->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pDeviceDiscoveringFailed->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
    ...
    case DeviceDiscoveringFailed:
      switch (state) {
        case Init:
          ltTransition = s_pDeviceDiscoveringFailedToInit->displayName(NULL);
          currentTransitionId = s_pDeviceDiscoveringFailedToInit->nodeId();
          setCurrentState(s_pInit->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pInit->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
    ...
    case DeviceDiscovered:
      switch (state) {
        case RetryConnection:
          ltTransition = s_pDeviceDiscoveredToRetryConnection->displayName(NULL);
          currentTransitionId = s_pDeviceDiscoveredToRetryConnection->nodeId();
          setCurrentState(s_pRetryConnection->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pRetryConnection->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
        ...
        case LinkSequenceDetecting:
          ltTransition = s_pDeviceDiscoveredToLinkSequenceDetecting->displayName(NULL);
          currentTransitionId = s_pDeviceDiscoveredToLinkSequenceDetecting->nodeId();
          setCurrentState(s_pLinkSequenceDetecting->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pLinkSequenceDetecting->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
          ...
          return OpcUa_Good;
        case Init:
          ltTransition = s_pDeviceDiscoveredToInit->displayName(NULL);
          currentTransitionId = s_pDeviceDiscoveredToInit->nodeId();
          setCurrentState(s_pInit->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pInit->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
    ...
    case RetryConnection:
      switch (state) {
        case DeviceDiscovered:
          ltTransition = s_pRetryConnectionToDeviceDiscovered->displayName(NULL);
          currentTransitionId = s_pRetryConnectionToDeviceDiscovered->nodeId();
          setCurrentState(s_pDeviceDiscovered->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pDeviceDiscovered->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
    ...
    case LinkSequenceDetecting:
      switch (state) {
        case LinkSequenceDetected:
          ltTransition = s_pLinkSequenceDetectingToLinkSequenceDetected->displayName(NULL);
          currentTransitionId = s_pLinkSequenceDetectingToLinkSequenceDetected->nodeId();
          setCurrentState(s_pLinkSequenceDetected->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pLinkSequenceDetected->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
        ...
        case LinkSequenceDetectingFailed:
          ltTransition = s_pLinkSequenceDetectingToLinkSequenceDetectingFailed->displayName(NULL);
          currentTransitionId = s_pLinkSequenceDetectingToLinkSequenceDetectingFailed->nodeId();
          setCurrentState(s_pLinkSequenceDetectingFailed->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pLinkSequenceDetectingFailed->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
    ...
    case LinkSequenceDetectingFailed:
      switch (state) {
        case RetryConnection:
          ltTransition = s_pLinkSequenceDetectingFailedToRetryConnection->displayName(NULL);
          currentTransitionId = s_pLinkSequenceDetectingFailedToRetryConnection->nodeId();
          setCurrentState(s_pRetryConnection->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pRetryConnection->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
          ...
          return OpcUa_Good;
        case IpConfiguring:
          ltTransition = s_pLinkSequenceDetectingFailedToIpConfiguring->displayName(NULL);
          currentTransitionId = s_pLinkSequenceDetectingFailedToIpConfiguring->nodeId();
          setCurrentState(s_pIpConfiguring->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pIpConfiguring->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
          ...
          return OpcUa_Good;
        case Init:
          ltTransition = s_pLinkSequenceDetectingFailedToInit->displayName(NULL);
          currentTransitionId = s_pLinkSequenceDetectingFailedToInit->nodeId();
          setCurrentState(s_pInit->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pInit->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
    ...
    case LinkSequenceDetected:
      switch (state) {
        case IpConfiguring:
          ltTransition = s_pLinkSequenceDetectedToIpConfiguring->displayName(NULL);
          currentTransitionId = s_pLinkSequenceDetectedToIpConfiguring->nodeId();
          setCurrentState(s_pIpConfiguring->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pIpConfiguring->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
          ...
          return OpcUa_Good;
        case Init:
          ltTransition = s_pLinkSequenceDetectedToInit->displayName(NULL);
          currentTransitionId = s_pLinkSequenceDetectedToInit->nodeId();
          setCurrentState(s_pInit->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pInit->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
    ...
    case IpConfiguring:
      switch (state) {
        case IpConfigured:
          ltTransition = s_pIpConfiguringToIpConfigured->displayName(NULL);
          currentTransitionId = s_pIpConfiguringToIpConfigured->nodeId();
          setCurrentState(s_pIpConfigured->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pIpConfigured->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
        ...
        case IpConfiguringFailed:
          ltTransition = s_pIpConfiguringToIpConfiguringFailed->displayName(NULL);
          currentTransitionId = s_pIpConfiguringToIpConfiguringFailed->nodeId();
          setCurrentState(s_pIpConfiguringFailed->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pIpConfiguringFailed->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
            getLastTransitionNode()->setIdNodeId(currentTransitionId);
            m_pLastTransition->setTransitionTime(UaDateTime::now());
    ...
    case IpConfigured:
      switch (state) {
        case Init:
          ltTransition = s_pIpConfiguredToInit->displayName(NULL);
          currentTransitionId = s_pIpConfiguredToInit->nodeId();
          setCurrentState(s_pInit->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pInit->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
    ...
    case IpConfiguringFailed:
      switch (state) {
        case IpConfiguring:
          ltTransition = s_pIpConfiguringFailedToIpConfiguring->displayName(NULL);
          currentTransitionId = s_pIpConfiguringFailedToIpConfiguring->nodeId();
          setCurrentState(s_pInit->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pInit->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
          ...
          return OpcUa_Good;
        case Init:
          ltTransition = s_pIpConfiguringFailedToInit->displayName(NULL);
          currentTransitionId = s_pIpConfiguringFailedToInit->nodeId();
          setCurrentState(s_pInit->displayName(NULL));
          getCurrentStateNode()->setIdNodeId(s_pInit->nodeId());
          setLastTransition(ltTransition);
          if (m_pLastTransition) {
...
BroadcastSearchAndIPSettingStateMachineTypeBase::BroadcastSearchAndIPSettingState
BroadcastSearchAndIPSettingStateMachineTypeBase::getBroadcastSearchAndIPSettingState() {
