/******************************************************************************
** moxaclassbased_projecttype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class ProjectType.
...
: ProjectTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
ProjectType::ProjectType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: ProjectTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class ProjectType with all components.
*/
ProjectType::ProjectType(
...
: ProjectTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void ProjectType::createTypes()
{
    // Call base class
    ProjectTypeBase::createTypes();
...
*/
void ProjectType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    ProjectTypeBase::clearStaticMembers();
}
