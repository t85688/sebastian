/******************************************************************************
** opcuaclassbnm_isrclasstype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class ISrClassType.
...
: ISrClassTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
ISrClassType::ISrClassType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: ISrClassTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class ISrClassType with all components.
*/
ISrClassType::ISrClassType(
...
: ISrClassTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void ISrClassType::createTypes()
{
    // Call base class
    ISrClassTypeBase::createTypes();
...
*/
void ISrClassType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    ISrClassTypeBase::clearStaticMembers();
}
