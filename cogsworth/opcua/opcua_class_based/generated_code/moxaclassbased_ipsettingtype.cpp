/******************************************************************************
** moxaclassbased_ipsettingtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IpSettingType.
...
: IpSettingTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IpSettingType::IpSettingType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IpSettingTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IpSettingType with all components.
*/
IpSettingType::IpSettingType(
...
: IpSettingTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IpSettingType::createTypes()
{
    // Call base class
    IpSettingTypeBase::createTypes();
...
*/
void IpSettingType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IpSettingTypeBase::clearStaticMembers();
}
