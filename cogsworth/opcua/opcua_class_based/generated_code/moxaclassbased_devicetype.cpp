...
/** Construction of the class DeviceType.
...
: DeviceTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
DeviceType::DeviceType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: DeviceTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class DeviceType with all components.
*/
DeviceType::DeviceType(
...
: DeviceTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void DeviceType::createTypes()
{
    // Call base class
    DeviceTypeBase::createTypes();
...
*/
void DeviceType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    DeviceTypeBase::clearStaticMembers();
}
