/******************************************************************************
** opcuaclassbnm_ieeetsnvlantagtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeTsnVlanTagType.
 ...
 */
IeeeTsnVlanTagType::IeeeTsnVlanTagType(
...
: IeeeTsnVlanTagTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeTsnVlanTagType::IeeeTsnVlanTagType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeTsnVlanTagTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeTsnVlanTagType with all components.
*/
IeeeTsnVlanTagType::IeeeTsnVlanTagType(
...
: IeeeTsnVlanTagTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeTsnVlanTagType::createTypes()
{
    // Call base class
    IeeeTsnVlanTagTypeBase::createTypes();
...
*/
void IeeeTsnVlanTagType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeTsnVlanTagTypeBase::clearStaticMembers();
}
