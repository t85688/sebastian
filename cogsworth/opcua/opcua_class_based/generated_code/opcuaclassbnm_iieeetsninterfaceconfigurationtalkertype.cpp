/******************************************************************************
** opcuaclassbnm_iieeetsninterfaceconfigurationtalkertype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IIeeeTsnInterfaceConfigurationTalkerType.
...
: IIeeeTsnInterfaceConfigurationTalkerTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IIeeeTsnInterfaceConfigurationTalkerType::IIeeeTsnInterfaceConfigurationTalkerType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IIeeeTsnInterfaceConfigurationTalkerTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IIeeeTsnInterfaceConfigurationTalkerType with all components.
*/
IIeeeTsnInterfaceConfigurationTalkerType::IIeeeTsnInterfaceConfigurationTalkerType(
...
: IIeeeTsnInterfaceConfigurationTalkerTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IIeeeTsnInterfaceConfigurationTalkerType::createTypes()
{
    // Call base class
    IIeeeTsnInterfaceConfigurationTalkerTypeBase::createTypes();
...
*/
void IIeeeTsnInterfaceConfigurationTalkerType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IIeeeTsnInterfaceConfigurationTalkerTypeBase::clearStaticMembers();
}
