/******************************************************************************
** opcuaclassbnm_ieeebasetsnstreamtype.cpp
**
**   **************************** auto-generated ****************************
...
/** Construction of the class IeeeBaseTsnStreamType.
 ...
 */
IeeeBaseTsnStreamType::IeeeBaseTsnStreamType(
...
: IeeeBaseTsnStreamTypeBase(nodeId, pInstanceDeclarationObject, pNodeConfig, pSharedMutex)
{
}
...
IeeeBaseTsnStreamType::IeeeBaseTsnStreamType(
    ...
    NodeManagerConfig* pNodeConfig,  //!< [in] Interface pointer to the NodeManagerConfig interface used to add and delete node and references in the address space
    UaMutexRefCounted* pSharedMutex) //!< [in] Shared mutex object used to synchronize access to the object. Can be NULL if no shared mutex is provided
: IeeeBaseTsnStreamTypeBase(nodeId, name, browseNameNameSpaceIndex, pNodeConfig, pSharedMutex)
{
}

/**  Constructs an instance of the class IeeeBaseTsnStreamType with all components.
*/
IeeeBaseTsnStreamType::IeeeBaseTsnStreamType(
...
: IeeeBaseTsnStreamTypeBase(pBaseNode, pFactory, pNodeConfig, pSharedMutex)
{
}
...
*/
void IeeeBaseTsnStreamType::createTypes()
{
    // Call base class
    IeeeBaseTsnStreamTypeBase::createTypes();
...
*/
void IeeeBaseTsnStreamType::clearStaticMembers()
{
    // Clear your static members here
    // Call base class
    IeeeBaseTsnStreamTypeBase::clearStaticMembers();
}
